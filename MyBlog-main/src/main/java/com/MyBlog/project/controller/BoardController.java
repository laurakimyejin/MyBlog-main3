...
//		Page<Board> dataList = boardService.categoryList(pageable, "daily");
		Page<Board> board = boardService.list(pageable);
//		List<BoardDto> board = boardService.findAll();
		model.addAttribute("boards", board); //board->daily
...
//		Page<Board> board = boardService.list(pageable);
//		model.addAttribute("boards", board);//board->knowledge
